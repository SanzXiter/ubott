...
〄➠ **ᴘᴇᴍʙᴜᴀᴛ ᴜsᴇʀʙᴏᴛ: sᴀʏᴀ ᴅɪ ᴋᴇᴍʙᴀɴɢᴋᴀɴ ᴏʟᴇʜ <a href=tg://op<enmessage?user_id={OWNER_ID}>sᴀɴᴢᴏғғɪᴄɪᴀʟ</a>
...
ᴏᴡɴᴇʀ ᴜsᴇʀʙᴏᴛ <a href=tg://openmessage?user_id={OWNER_ID}>sᴀɴᴢ ᴏғғɪᴄᴇ</a> 
...
"""
    ...
    def POLICY():
        return """ ᴊɪᴋᴀ ᴀᴅᴀ ᴋᴇɴᴅᴀʟᴀ sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ  <a href=tg://openmessage?user_id={OWNER_ID}>sᴀɴᴢ ᴏғғɪᴄɪᴀʟ</a> 
"""
